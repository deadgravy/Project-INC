...
const Boxe = ({data}) => {
  ...
  const bgColor = ["#0CA85D", "#9F43CC", "#EBA10F", "#2B87E3", "#fc0303", "#31ebf5"]
        ...
        <Box
          ...
          >
             ...
             <div className="BoxSubHeader">
              {data?.data[count].avg.days ? `${data?.data[count].avg.days} days` : ""}{" "}
              ...
              {data?.data[count].avg.seconds
                ...
                : ""}{" "}
                 {data?.data[count].avg.milliseconds ? `${data?.data[count].avg.milliseconds} milliseconds` : ""}{" "}
            </div>
          </Box>
          </div>
        )
