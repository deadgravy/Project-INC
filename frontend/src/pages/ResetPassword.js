    ...
    <div className='row resetPWPage'>
      <div className='resetPWContainer col-12'>
        <div className='card offset-4 p-4 px-6'>
          ...
          <p>Please fill in your email and your new password.</p>
          <form onSubmit={handelSubmit}>
            ...
            {email && password === null && errorAlert()}
            <button type='submit' className='btn-danger mt-2 u-pull-right'>
              Reset Password
            </button>
          </form>
          <div className='mt-3'>
